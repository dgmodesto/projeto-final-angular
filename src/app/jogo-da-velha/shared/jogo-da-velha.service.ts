...
export class JogoDaVelhaService {
  ...
  fimJogo(linha: number, coluna: number, tabulerio: any, jogador: number) {
    let fim: any = false;

    // valida a linha
    if (
      tabulerio[linha][0] === jogador &&
